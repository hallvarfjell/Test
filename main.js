...
(function(){
 ...
 if(!b) return;
 b.classList.remove('connected','disconnected');
 b.classList.add(connected? 'connected':'disconnected');
 }
 const STATE = {
 ...
 const lab = document.getElementById('rpe-label');
 if(lab) lab.textContent = 'RPE nå: ' + rpeLevelName(STATE.rpe);
 }
